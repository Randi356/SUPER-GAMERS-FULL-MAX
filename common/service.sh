...
echo '268435456' > /proc/sys/kernel/shmax
...
echo '1' > /proc/sys/vm/reap_mem_on_sigkil;
...
echo 96 96 > /proc/sys/vm/owmem_reserve_ratio
echo 6075 > /proc/sys/vm/extra_free_kbytes
sleep 30
chmod 664 /sys/module/lowmemorykiller/parameters/adj
echo "0,1,3,5,10,15" > /sys/module/lowmemorykiller/parameters/adj
